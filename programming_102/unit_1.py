...
while True:
    ...
    if user == computer: #changed users to user
        print("Looks like a tie") #added a closing parenthasis
    ...
    # check all cases if user is rock
        ...
        # check losing case
        elif computer == "paper":    #changed from rock to to paper because logic was incorrect
    ...
    # check all cases if user is paper
        ...
        # check winning case
        if computer == "rock": #added a colon
            print("You win!")
    ...
    # check all cases if user is scissors
        ...
        # check losing case
            ...
            print("Sorry, You lose.") #change capital P to lowercase p